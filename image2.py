...
def detect_light(mask, color_name):
...
if detect_light(mask_red, "紅燈"):
    light_color = "red"
    light_BGR = (0,0,255)
elif detect_light(mask_yellow, "黃燈"):
    light_color = "yello"
    light_BGR = (0,255,255)
elif detect_light(mask_green, "綠燈"):
    light_color = "green"
    light_BGR = (0,255,0)
...
# 繪製燈號框
if light_color:
    cv2.putText(image, f"{light_color}", (20, 20),
